package quorum.app.client.clients;
	...
	public void startClient4() throws Exception {
		...
		try {
			...
			if (Constants.ENABLE_SOCKET_CLOSE) {
				while (Utils.checkTimeout(start, Utils.getTimestamp()) <= Constants.CLIENT_TIMEOUT + 2) {
					Thread.sleep(30000);
				}
...
//		s1 = new Socket(Constants.CLIENT1, Constants.CLIENT4_PORT);
//		s2 = new Socket(Constants.CLIENT2, Constants.CLIENT4_PORT);
//		s3 = new Socket(Constants.CLIENT3, Constants.CLIENT4_PORT);
