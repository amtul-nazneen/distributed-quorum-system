...
public class Client5 {
	...
	/*
	 * MutualExclusionImpl myMutexImpl; int processnum = 5; int counter = 0;
	 * 
	 * Socket server1 = null, server2 = null, server3 = null; Socket s2, s1, s3, s4;
	 * ServerSocket ss5;
	 * 
	 * PrintWriter w1, w2, w3, w4; BufferedReader r1, r2, r3, r4; PrintWriter
	 ...
	 *//**
		 ...
		 */
	/*
	 * public void startClient5() throws Exception { Timestamp start =
	 ...
	 * startChannelThreads(); init(); while (counter < Constants.CLIENT5_CSLIMIT) {
	 ...
	 * Utils.log(e.getMessage()); } finally { if (Constants.ENABLE_SOCKET_CLOSE) {
	 * while (Utils.checkTimeout(start, Utils.getTimestamp()) <=
	 * Constants.CLIENT_TIMEOUT) { Thread.sleep(30000); }
	 ...
	 * Thread.sleep(Constants.CLIENT5_CSEXEC); } catch (InterruptedException e) {
	 * e.printStackTrace(); }
	 ...
	 * Socket(Constants.CLIENT1, Constants.CLIENT5_PORT); // s2 = new
	 * Socket(Constants.CLIENT2, Constants.CLIENT5_PORT); // s3 = new
	 * Socket(Constants.CLIENT3, Constants.CLIENT5_PORT); // s4 = new
	 * Socket(Constants.CLIENT4, Constants.CLIENT5_PORT); }
	 * 
	 *//**
	 ...
	 * InputStreamReader(s4.getInputStream())); }
	 * 
	 *//**
		 ...
		 */
	/*
	 * private void createMutexImplementor() throws Exception { myMutexImpl = new
	 ...
	 * QuorumClientHandler(s3, myMutexImpl); QuorumClientHandler css4 = new
	 * QuorumClientHandler(s4, myMutexImpl); Thread t1 = new Thread(css1); Thread t2
	 * = new Thread(css2); Thread t3 = new Thread(css3); Thread t4 = new
	 * Thread(css4); t1.start(); t2.start(); t3.start(); t4.start(); }
	 * 
	 *//**
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * server3.close(); s1.close(); s2.close(); s3.close(); s4.close(); } catch
			 * (Exception e) { } }
			 */
}
