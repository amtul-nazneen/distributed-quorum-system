...
/**
 * Central class that handlers Client 3 actions
 */
public class Client3 {

	/*
	 * MutualExclusionImpl myMutexImpl; int processnum = 3; int counter = 0;
	 * 
	 * Socket server1 = null, server2 = null, server3 = null; Socket s2, s1, s4, s5;
	 * ServerSocket ss4, ss5;
	 * 
	 * PrintWriter w1, w2, w4, w5; BufferedReader r1, r2, r4, r5; PrintWriter
	 ...
	 * 
	 *//**
		 * Started method to initiate Client 3. Connects to Servers 1,2 and 3, Client 1,
		 * 2 and initialises Channel Readers and Writers. Opens connections for the
		 * remaining 2 Clients and initialises Channel Readers and Writers once
		 ...
		 */
	/*
	 * public void startClient3() throws Exception { Timestamp start =
	 ...
	 * Thread.sleep(Constants.CLIENT3_CSEXEC); } catch (InterruptedException e) {
	 * e.printStackTrace(); }
	 ...
	 * writeToServer2.println(Constants.ENQUIRE + "," + processnum); boolean
	 * gotReply = false; String reply = ""; while (!gotReply) { reply =
	 * readFromServer2.readLine(); if (reply != null) { gotReply = true; } }
	 ...
	 * Socket(Constants.CLIENT1, Constants.CLIENT3_PORT); // s2 = new
	 * Socket(Constants.CLIENT2, Constants.CLIENT3_PORT); // ss4 = new
	 * ServerSocket(Constants.CLIENT4_PORT); // ss5 = new
	 * ServerSocket(Constants.CLIENT5_PORT); s4 = ss4.accept(); s5 = ss5.accept(); }
	 * 
	 *//**
	 ...
	 * InputStreamReader(s2.getInputStream())); w4 = new
	 ...
	 * MutualExclusionHelper.assignChannelWriters(myMutexImpl, w1, w2, w4, w5); }
	 * 
	 *//**
	 ...
	 * QuorumClientHandler(s2, myMutexImpl); QuorumClientHandler css4 = new
	 ...
	 * = new Thread(css2); Thread t4 = new Thread(css4); Thread t5 = new
	 * Thread(css5); t1.start(); t2.start(); t4.start(); t5.start(); }
	 * 
	 *//**
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * server3.close(); s1.close(); s2.close(); s4.close(); s5.close(); ss4.close();
			 * ss5.close(); } catch (Exception e) { } }
			 */
}
